namespace TheScriptingEngineerPostProcessing1980
{
    using System;
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            EnvelopeResults(envelopeInputs, "maxVonMises", "maxVonMises", ResultsManipulationEnvelopeBuilder.Operation.Maximum, Result.ShellSection.Maximum, Result.Component.VonMises, false, "Transverse");

            EnvelopeResults("Combined", "Stress - Element-Nodal", "maxVonMisesComb", "Combined.unv", ResultsManipulationEnvelopeBuilder.Operation.Maximum, Result.ShellSection.Maximum, Result.Component.VonMises, false);
        ...
        public static void EnvelopeResults(string solutionName, string resultType, string companionResultName, string unvFileName, ResultsManipulationEnvelopeBuilder.Operation envelopeOperation,  Result.ShellSection resultShellSection, Result.Component resultComponent, bool absolute)
        {
            // user feedback
            ...
            EnvelopeResults(envelopeInputs, companionResultName, unvFileName, envelopeOperation, resultShellSection, resultComponent, absolute, solutionName);
        }
        ...
        public static void EnvelopeResults(PostInput[] postInputs, string companionResultName, string unvFileName, ResultsManipulationEnvelopeBuilder.Operation envelopeOperation,  Result.ShellSection resultShellSection, Result.Component resultComponent, bool absolute, string solutionName = "")
        {
            ...
            ResultParameters[] resultParameters = GetResultParamaters(resultTypes, resultShellSection, resultComponent, absolute);

            ResultsManipulationEnvelopeBuilder resultsManipulationEnvelopeBuilder;
            resultsManipulationEnvelopeBuilder = theSession.ResultManager.CreateResultsManipulationEnvelopeBuilder();
            resultsManipulationEnvelopeBuilder.InputSettings.SetResultsAndParameters(solutionResults, resultParameters);
            
            resultsManipulationEnvelopeBuilder.OperationOption = envelopeOperation;
            
            resultsManipulationEnvelopeBuilder.OutputFileSettings.ResultModeOption = ResultsManipOutputFileSettings.ResultMode.Companion;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.AppendMethodOption = ResultsManipOutputFileSettings.AppendMethod.CreateNewLoadCase;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.NeedExportModel = false;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.OutputName = envelopeOperation.ToString() + " " + resultTypes[0].Quantity.ToString() + " (" + resultComponent.ToString() + ")";
            resultsManipulationEnvelopeBuilder.OutputFileSettings.LoadCaseName = companionResultName;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.CompanionName = companionResultName;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.NeedLoadImmediately = true;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.OutputFile = unvFullName;
            resultsManipulationEnvelopeBuilder.OutputFileSettings.CompanionResultReference = simResultReference;

            resultsManipulationEnvelopeBuilder.UnitSystem.UnitsSystemType = NXOpen.CAE.ResultsManipulationUnitsSystem.Type.FromResult;
            resultsManipulationEnvelopeBuilder.UnitSystem.Result = solutionResults[0];

            resultsManipulationEnvelopeBuilder.ErrorHandling.IncompatibleResultsOption = ResultsManipulationErrorHandling.IncompatibleResults.Skip;
            resultsManipulationEnvelopeBuilder.ErrorHandling.NoDataOption = ResultsManipulationErrorHandling.NoData.Skip;

            try
            {
                resultsManipulationEnvelopeBuilder.Commit();
                ...
                for (int ii = 0; ii < postInputs.Length; ii++)
                {
                    theLW.WriteFullline(fullResultNames[ii]);
                }
                theLW.WriteFullline("Section location: " + resultShellSection.ToString());
            ...
            {
                resultsManipulationEnvelopeBuilder.Destroy();
            }
        }
